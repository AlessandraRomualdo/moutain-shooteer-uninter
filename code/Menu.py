...
from code.Cont import WIN_WIDTH, C_ORANGE, MENU_OPTION, C_WHITE, C_YELLOW
    ...
    def run(self):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(20, MENU_OPTION[i], C_YELLOW, ((WIN_WIDTH / 2), 150 + 25 * i))
                else:
                    self.menu_text(20, MENU_OPTION[i], C_WHITE, ((WIN_WIDTH / 2), 150 + 25 * i))
            pygame.display.flip()
